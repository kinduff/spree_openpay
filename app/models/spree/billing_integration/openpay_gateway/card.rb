module Spree
  class BillingIntegration::OpenpayGateway::Card < Gateway
    ...
    preference :use_wallet, :boolean, default: false

    unless Rails::VERSION::MAJOR == 4
      attr_accessible :preferred_auth_token, :preferred_public_auth_token, :preferred_source_method, :gateway_response, :preferred_openpay_id, :preferred_use_wallet
    end
